...
const About = () => {
  return (
    <main className="flex flex-col m-6 gap-6">
      ...
      <div className="flex flex-col md:flex-row-reverse justify-evenly mb-40 bg-slate-300 rounded-3xl">
        <img
          className="w-10/12 md:w-5/12 place-self-center m-2 p-4 rounded-full"
          src="./images/second_image.jpg"
          alt="placeholder"
        ></img>
        <div className="flex flex-col justify-center text-center gap-10 md:gap-20 m-6 text-green-950">
          <h1 className="text-4xl md:text-5xl font-bold">Richard Dalrymple</h1>
          <p className="text-lg md:text-2xl">
            Choose your tree species based on our recommendations
          </p>
        </div>
