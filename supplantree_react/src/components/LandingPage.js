        ...
        <div className="flex flex-col gap-8 md:gap-12 justify-center text-center md:w-5/12">
          ...
          >
            <a href="http://localhost:3000/plant">
              <button
                className="bg-slate-300 border-white border-4 hover:bg-pink-200 transition duration-150 
              ease-out hover:ease-in hover:scale-110 active:scale-90 m-4 p-3 w-36 rounded-lg shadow-lg shadow-gray-600"
              >
                Get Planting!
              </button>
            </a>
