    ...
    return (
      ...
      >
        <div className="flex flex-col justify-center">
          ...
          <br />
          <button
            className="bg-slate-300 place-self-center border-white border-4 hover:bg-pink-200 transition duration-150 ease-out hover:ease-in hover:scale-110 active:scale-90 m-4 p-3 w-36 rounded-lg shadow-lg shadow-gray-600"
            onClick={onDelete}
          >
            Delete
          </button>
